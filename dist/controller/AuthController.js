...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.authenticate = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, user, isPasswordValid, token, id;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!isPasswordValid) {
                            return [2 /*return*/, res.json({ error: "password invalid" })];
                        }
                        token = (0, jsonwebtoken_1.sign)({ id: user.id }, "secret", { expiresIn: "1h" });
                        id = user.id;
                        return [2 /*return*/, res.json({ user: { id: id, email: email }, token: token })];
                }
            });
        });
    };
